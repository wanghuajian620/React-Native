...
var amVAR = {};
		function changeText() {
		    $NoticeBar("_NoticeBar").changeText("changeText方法生效了");
		}
...
<ScrollView amtype="ScrollView">
 ...
 <View style={{ marginTop : px2rn(20) , fontSize : px2rn(16) }}>
  <Text style={{ fontSize : px2rn(16) }}>
   changeText方法->设置通告栏文本
  </Text>
 </View>
 <NoticeBar amtype="NoticeBar" mode="link" id="_NoticeBar" autoref="_NoticeBar" ref="__NoticeBar">
  <Text>
    Notice: The arrival time of incomes and transfers of Yu 'E END
  </Text>
 </NoticeBar>
 <WhiteSpace amtype="WhiteSpace"></WhiteSpace>
 <Button amtype="Button" type="primary" text="changeText方法" click="changeText()" onClick={($event)=>changeText()}></Button>
</ScrollView>    
</View>);
  }
}
