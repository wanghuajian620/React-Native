...
public class RSAEncryptor {
    ...
    public String decryptWithBase64(String base64String) throws Exception {
        byte[] binaryData = decrypt(getPrivateKey(), Base64.decode(base64String,0));
...
//            BASE64Decoder base64Decoder= new BASE64Decoder();
    ...
    public byte[] publicEncrypt( byte[] plainTextData)
            throws Exception {
        if (publicKey == null) {
            throw new Exception("加密公钥为空, 请设置");
        }
     ...
     *             解密过程中的异常信息
     */
    public byte[] priviteDecrypt(byte[] cipherData)
            throws Exception {
        if (privateKey == null) {
            throw new Exception("解密私钥为空, 请设置");
        }
     ...
     * @throws Exception 加载公钥时产生的异常
     */
    public RSAEncryptor loadPubKey(InputStream in) throws Exception {
        try {
            BufferedReader br= new BufferedReader(new InputStreamReader(in));
            String readLine= null;
            StringBuilder sb= new StringBuilder();
