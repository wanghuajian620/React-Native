package com.cib.library.encrypt.sm2;

import com.cib.library.encrypt.Cipher;
...
//        System.out.println(plainText);
    ...
    */
    public static String SM2Encrypt(String content)
    {
        ...
        try {
            cipherContent = SM2Utils.encrypt(getpublicKey(), sourceData);
        } catch (IOException e) {
            e.printStackTrace();
        }
        return cipherContent.toUpperCase();
    }
}
