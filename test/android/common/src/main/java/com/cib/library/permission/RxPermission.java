...
public class RxPermission {
    ...
    static String TAG = "RxPermission";
    static final Object TRIGGER = new Object();
    private static Activity instanceActivity = null;
    private static RxPermission instance;

    RxPermissionsFragment mRxPermissionsFragment;


    private RxPermission(@NonNull Activity activity) {
        mRxPermissionsFragment = getRxPermissionsFragment(activity);
    }

    public static RxPermission getIntance(Activity activity, String tag) {
        TAG = tag;
        if (instanceActivity == null) {
            instance = new RxPermission(activity);
        } else {
            instance = new RxPermission(instanceActivity);
        }
        return instance;
    }
